import{_ as l,X as i,Y as u,Z as n,$ as s,a0 as a,a2 as e,a1 as o,D as c}from"./framework-dfc585d8.js";const d="/studio/assets/insert-dc46da8f.png",k="/studio/assets/select-dbf47e57.png",r="/studio/assets/update-5b4db3a2.png",m="/studio/assets/update-preview-6743e612.png",v="/studio/assets/del-ca3ab409.png",b="/studio/assets/del-pre-4c009f85.png",g={},y=n("p",null,"作者：村雨遥",-1),q={href:"https://ez4jam1n.github.io/studio",target:"_blank",rel:"noopener noreferrer"},h=o(`<blockquote><p>吾生也有涯，而知也无涯。</p></blockquote><hr><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>上一篇文章中我们讲了什么是持久化以及 Mybatis 的相关简介，今天就来看看如何创建一个 Mybatis 入门实例以及如何利用 Mybatis 进行 CRUD。</p><h2 id="数据库准备" tabindex="-1"><a class="header-anchor" href="#数据库准备" aria-hidden="true">#</a> 数据库准备</h2><ol><li>首先，我们来创建一个数据库，用于后序步骤的使用；</li></ol><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">DATABASE</span> test<span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">DeleteTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+v+'" alt=""></p><p><img src="'+b+'" alt=""></p><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2><p>以上就是我们今天的所有内容了，原创不易，如果你觉得我的文章对你有所帮助，那就帮忙点赞关注吧，我们就下篇文章再见吧 ~</p><p>而关于文章中的示例代码，我已经上传到了 Github，如果有需要的朋友，可以自取。</p>',46),f={href:"https://github.com/ez4jam1n/java-learning-demos",target:"_blank",rel:"noopener noreferrer"};function x(j,U){const t=c("ExternalLinkIcon"),p=c("RouterLink");return i(),u("div",null,[y,n("p",null,[s("博客："),n("a",q,[s("studio"),a(t)])]),h,n("ol",null,[n("li",null,[s("对于如何创建 Maven 工程，可以参照我之前写的一篇文章："),a(p,{to:"/md/java/maven/20220104-maven-project-with-idea.html"},{default:e(()=>[s("利用 IDEA 搭建一个 Maven 项目 ")]),_:1})]),n("li",null,[s("接着在项目的 "),w,s(" 中添加 MyBatis、MySQL、Junit 以及 Lombok 的依赖，关于更多 Lombok 的使用，可以参考我的另一篇文章："),a(p,{to:"/md/java/se/20220719-lombok-install-and-usage.html"},{default:e(()=>[s("Lombok 安装及使用指南")]),_:1})])]),S,n("blockquote",null,[n("p",null,[s("传送门："),n("a",f,[s("https://github.com/ez4jam1n/java-learning-demos"),a(t)])])])])}const E=l(g,[["render",x],["__file","20220202-quick-start.html.vue"]]);export{E as default};
