...
可以看到原本 `button` 标签的属性 `innerText` 从原先的点击变成了 benjamin，说明通过修改 JavaScript 对象属性从而改变 HTML 中标签属性的目的达到了。
...
<html>
	...
	<body>
		<script>
			document.write('公众号：benjamin！</br>');
...
<html>
	...
	<body>
		...
		<script>
			...
			div.innerHTML = '<a href="https://benjam1n.eu.org">studio</a>';
		</script>
	</body>
</html>
```
