...
```java
// 根据传入的字符串内容创建字符串对象
String wepublic = new String("benjamin");
```
...
public class EqualsIgnoreCaseTest {
    public static void main(String[] args) {
        String str1 = "ez4jam1n";
        String str2 = "ez4jam1n";
...
public class StringBuilderConstrcutor {
    public static void main(String[] args) {
        ...
        StringBuilder stringBuilder1 = new StringBuilder("benjamin");
...
public class StringBuilderMethodTest {
    public static void main(String[] args) {
        StringBuilder stringBuilder = new StringBuilder("benjamin");

        System.out.println("原字符串：" + stringBuilder);

        System.out.println("length(): " + stringBuilder.length());

        stringBuilder.append("ez4jam1n");
