...
![](./assets/20220402-halo/jdk-download.png)
...
![](./assets/20220402-halo/record.png)
...
![](./assets/20220402-halo/open-port.png)
...
只需要将其中的 `example.com` 修改成自己的域名即可，比如我的域名是 `ez4jam1n.site`；
...
![](./assets/20220402-halo/renew.png)
