...
![](./assets/20220202-idea-guide/offcial-website.png)

因为我有旗舰版的账号，所以这里就以旗舰版安装为例，其实社区版的安装也是一样的，只不过里边集成的东西有所不同。所以如果你安装的是社区版，参照此教程也是完全可以的！

![](./assets/20220202-idea-guide/download.png)
...
![](./assets/20220202-idea-guide/welcome.png)
...
![](./assets/20220202-idea-guide/path-set.png)
...
![](./assets/20220202-idea-guide/install-options.png)

4.  选择开始菜单中给 IDEA 的文件夹名，这里默认即可，直接点击 `Install`，然后就是漫长的等待安装过程了！

![](./assets/20220202-idea-guide/start-menu.png)

![](./assets/20220202-idea-guide/installing.png)

5.  大功告成！显示此界面就说明我们的 `IDEA` 已经安装好了，直接点击 `Finish` 即可！

![](./assets/20220202-idea-guide/finish.png)
...
![](./assets/20220202-idea-guide/license.png)
...
![](./assets/20220202-idea-guide/encode-setting.png)
...
![](./assets/20220202-idea-guide/ui.png)
...
![](./assets/20220202-idea-guide/theme.png)
...
![](./assets/20220202-idea-guide/mouse-wheel.png)
...
![](./assets/20220202-idea-guide/console.png)

### 扁平化显示及空包隐藏

有时候，我们项目的包结构会变成如下样式，有时会造成一定的不便，此时是因为开启了 `Flatten Packages` 所导致。

![](./assets/20220202-idea-guide/flatten-pkg-on.png)

如果我们关闭此功能，则项目包结构如下所示：

![](./assets/20220202-idea-guide/flatten-pkg-off.png)
...
![](./assets/20220202-idea-guide/mul-row.png)
...
![](./assets/20220202-idea-guide/line-num.png)
...
![](./assets/20220202-idea-guide/auto-import.png)
...
![](./assets/20220202-idea-guide/match-case.png)
...
![](./assets/20220202-idea-guide/build-auto.png)
...
![](./assets/20220202-idea-guide/compiler.png)
...
![](./assets/20220202-idea-guide/maven-setting.png)
 ...
 * @公众号        : benjamin
 * @Website      : https://benjam1n.eu.org
 * @Description  :
 */
```

![img](./assets/20220202-idea-guide/class-temp.png)
...
![](./assets/20220202-idea-guide/export.png)

#### 导入

导入入口，依次打开 `File -> Manage IDE Settings -> Import Settings…`。

![](./assets/20220202-idea-guide/import.png)
